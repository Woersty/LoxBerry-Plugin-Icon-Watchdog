...
{
	// Current availavle icon Types are IconCat, IconState and IconPlace
...
function import_loxone_project($file)
{
	...
	$json = array();
	$xml = convert_icons($xml,array("IconCat","IconState","IconPlace"));
	...
	$converted_file = str_replace("",".Loxone",$file)."_converted.Loxone";
	file_put_contents($converted_file,$data['xml']);
	chmod($converted_file, 0666);
	return $data;
}
